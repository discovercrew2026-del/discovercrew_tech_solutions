...
export default function ThreeBackground({ currentPanel }) {
  ...
  React.useEffect(() => {
    ...
    const camTargets = [
      { pos: new THREE.Vector3(-1.8, 1.5, 9), look: new THREE.Vector3(1.0, 0, 0) },
      { pos: new THREE.Vector3(1.5, -0.5, 5.5), look: new THREE.Vector3(-1.0, 0, 0) },
      { pos: new THREE.Vector3(2.8, -0.4, 5.0), look: new THREE.Vector3(1.2, 0, 0) },
      { pos: new THREE.Vector3(-2.8, 0.4, 6.0), look: new THREE.Vector3(-1.2, 0, 0) },
      { pos: new THREE.Vector3(-1.8, 1.5, 9), look: new THREE.Vector3(1.0, 0, 0) },
    ];
    let camProgress = 0;
    ...
    function animate3D() {
      ...
      if (window._camProgress !== undefined) camProgress = window._camProgress;
