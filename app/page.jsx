...
// Three.js canvas must be loaded client-side only (no SSR)
...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* Progress bar */}
      <div className="progress-bar" id="prog" ref={progRef}></div>
      ...
      {/* Scroll hint */}
      <div className="scroll-hint" id="hint" style={{ opacity: currentSec === 0 ? 1 : 0 }}>
